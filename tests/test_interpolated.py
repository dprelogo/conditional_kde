...
class TestInterpolatedConditionalGaussian:
    ...
    def test_score_samples(self, grid_data_1d):
        ...
        log_probs = icg.score_samples(X, inherent_conditionals, conditional_features=[0])
        assert log_probs.shape == (10,)
    ...
    def test_sample(self, grid_data_1d):
        ...
        conditionals = {0: 1.0}
        samples = icg.sample(inherent_conditionals, conditionals=conditionals, n_samples=50)
        assert samples.shape == (50, 2)  # One less due to additional conditional
        
        # Test with keep_dims
        samples = icg.sample(inherent_conditionals, conditionals=conditionals, n_samples=50, keep_dims=True)
...
class TestInterpolatedConditionalKernelDensity:
    ...
    def test_score_samples(self, grid_data_1d):
        ...
        # Test with conditional features
        log_probs = ickde.score_samples(X, inherent_conditionals, conditional_features=[0])
        assert log_probs.shape == (10,)
    ...
    def test_sample_rescale(self, grid_data_1d):
        ...
        # Test with additional conditionals
        conditionals = {0: 1.0}
        samples = ickde.sample(inherent_conditionals, conditionals=conditionals, n_samples=50)
